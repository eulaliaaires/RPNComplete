...
//		args [1] = "../StackerPrograms/program/Calc2.stk";
	 ...
	 * @throws Exception 
	 */
	private static void runFile(String sourceFilePath) throws Exception {
	...
	private static void run(String source) throws Exception {
		try {
			interpreter.env.put("y", new String ("10"));
			...
			Parser parser = new Parser(tokens, interpreter);
	...
	// HELPERS METHODS
	// -------------------------------------------------------------
	private static void run(String[] args, boolean debugging) throws Exception {
